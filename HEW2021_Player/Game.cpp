...
void gameThread(PGamePlay const p_this)
{
	...
	GAMESTATE m_gstate;
	m_gstate = PLAYER_SCN_INIT;
	//m_gstate = GREEN_SOUL_INIT;
	//m_gstate = RED_SOUL_INIT;


	void(*PlayerScene[])(GAMESTATE*)
	{
		//System_Init,
		Player,
		Green_Abs,
	...
	while (m_gstate != APP_EXIT)//m_bAtomActive
	{
		...
		switch (m_gstate)
		{
			case PLAYER_SCN_INIT:
			case PLAYER_SCN:	PlayerScene[PLAYER_SCN_INIT](&m_gstate);
			break;
			case GREEN_SOUL_INIT:
			case GREEN_SOUL:	PlayerScene[GREEN_SOUL_INIT](&m_gstate);
			break;
			case BLUE_SOUL_INIT:
			case BLUE_SOUL:		PlayerScene[BLUE_SOUL_INIT](&m_gstate);
			break;
			case RED_SOUL_INIT:
			case RED_SOUL:		PlayerScene[RED_SOUL_INIT](&m_gstate);
			break;
			/*
			case WINDOW_SOUL_INIT:
			case WINDOW_SOUL:		PlayerScene[WINDOW_SOUL_INIT](&m_gstate);
			break;*/
